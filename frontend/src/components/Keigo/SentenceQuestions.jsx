...
function SentenceQuestions({ onCleared }) {
    const questions = [
        ...
        { id: 2, sentence: "木村さんがいますか", normal: ["さん", "います"], formal: [["さま", "様", "sama"], ["いらっしゃいます", "イラッシャイマス", "irasshaimasu"]], image: image_3 },
    ]
                    ...
                    <div className="feedback">
                        {
                            questions[currentQuestion].sentence
                                ...
                                .map((part, index) =>
                                    part === questions[currentQuestion].normal.find(word => !clearedWords.includes(word)) ? (
