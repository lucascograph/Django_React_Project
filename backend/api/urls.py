...
urlpatterns = [
    ...
    path("flashcard/delete/<int:id>/", views.DeleteFlashcard.as_view(), name="delete-flashcard"),
    ...
    path('api/deck/share/<uuid:code>/', views.RetrieveDeckByCode.as_view(), name='share-deck'),
    path('api/deck/duplicate/', views.DuplicateDeck.as_view(), name='duplicate-deck'),
